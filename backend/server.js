...
// Social auth dummy routes
app.get('/api/auth/google', (req, res) => res.redirect('http://localhost:3000/dashboard'));
app.get('/api/auth/github', (req, res) => res.redirect('http://localhost:3000/dashboard'));
app.get('/api/auth/microsoft', (req, res) => res.redirect('http://localhost:3000/dashboard'));
